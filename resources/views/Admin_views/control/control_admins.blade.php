...
@section('content')
    <div class="row justify-content-center">
        ...
        <div class="card-body text-center thirdColor">
            <h1>{{$records->count()-1}}</h1>
            <div class="my-2"><label>{{__("إجمالي المشرفين")}}</label></div>
        </div>
        </div>

        <div class="card card-main mx-2 my-2 col-10 col-sm-10 col-md-4 col-lg-3 col-xl-3">
        <div class="card-body text-center mainColor">
            <h1>{{$num_admins}}</h1>
            <div class="my-2"><label>{{__("المشرفين")}}</label></div>
        </div>
        </div>
        ...
        <div class="card-body text-center text-info">
            <h1>{{$num_subAdmins}}</h1>
            <div class="my-2"><label>{{__("المشرفين المساعدين")}}</label></div>
        </div>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        @include('_helper.admin._table_of_admins')
    </div>
@endsection
