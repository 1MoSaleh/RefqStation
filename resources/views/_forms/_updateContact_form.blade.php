<div class="col-12 col-sm-9 col-md-9 col-lg-8 col-xl-7 mx-auto">
    ...
    <div class="contact-number form-group">
            ...
            @if($layout == 'rescue')
            <label for="phoneNumber">{{__("رقم الجوال")}}</label>  <small class=" text-muted mx-2" >{{__("اختياري")}}</small> <br>
            <div class="input-group">
            <input type="text" name="phoneNumber" id="phoneNumber" value="{{$update[0]->contact->phoneNumber}}" class="form-control" maxlength="9" minlength="9" >
