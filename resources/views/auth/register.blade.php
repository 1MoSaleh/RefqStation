...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color: rgba(0, 189, 175, 0.7)">
                        <h5 class="secondaryColor">{{ __('التسجيل') }}</h5>
                    </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <label>{{__("بإتمامك للتسجيل فأنت توافق على")}} <a href="{{route('terms')}}">{{__("الشروط والأحكام")}}</a></label>
